...
func init() {
  migration.GetMigrator().AddMigration(&migration.Migration{
    Version: "20240715232843",
    Up:      mig_20240715232843_create_orgs_table_up,
    Down:    mig_20240715232843_create_orgs_table_down,
  })
}

func mig_20240715232843_create_orgs_table_up(tx *sql.Tx) error {
...
func mig_20240715232843_create_orgs_table_down(tx *sql.Tx) error {
