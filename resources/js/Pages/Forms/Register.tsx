    ...
    <div className="w-1/3 mx-auto">
      ...
      <form onSubmit={submit}>
        ...
        <div className="mt-2">
          ...
          />
          {errors.username && (
            <p className="text-xs text-red-500">{errors.username.join(", ")}</p>
          )}
        </div>
        ...
        <div className="mt-2">
          ...
          ></textarea>
          {errors.bio && (
            <p className="text-xs text-red-500">{errors.bio.join(", ")}</p>
          )}
        </div>
        ...
        <div className="mt-2">
          ...
          <input id="avatar" name="avatar" type="file" onChange={handleInput} />
          {errors.avatar && (
            <p className="text-xs text-red-500">{errors.avatar.join(", ")}</p>
          )}
        </div>
        ...
        <div className="mt-2">
          <label htmlFor="password_confirmation" className="label-primary">
        ...
        <div className="mt-2">
          <label htmlFor="org_name" className="label-primary">
            Org Name
          </label>
          <input
            id="org_name"
          ...
          />
          {errors.org_name && (
            <p className="text-xs text-red-500">{errors.org_name.join(", ")}</p>
          )}
        </div>

        <div className="mt-2">
          <label htmlFor="org_email" className="label-primary">
            Org Email
          </label>
          <input
            id="org_email"
          ...
          {errors.org_email && (
            <p className="text-xs text-red-500">
              {errors.org_email.join(", ")}
            </p>
          )}
        </div>

        <div className="mt-2">
          <label htmlFor="org_logo" className="label-primary">
            Org Logo
          </label>
          <input
            id="org_logo"
          ...
          />
          {errors.org_logo && (
            <p className="text-xs text-red-500">{errors.org_logo.join(", ")}</p>
          )}
        </div>
