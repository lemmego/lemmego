    ...
    <div
      ...
      <div class="mx-auto">
        <div class="flex items-center justify-center space-x-6">
          <img src="https://avatars.githubusercontent.com/u/109903896?s=200&v=4" alt="Lemmego" class="w-20 h-20" />
        </div>
        <div class="divide-y divide-gray-300 dark:divide-gray-700">
          <div class="py-8 text-base leading-7">
            ...
            <h2 class="font-semibold mt-6 text-red-500 hover:text-red-600">🔋Batteries Included</h2>
            <p>Built in support for sessions, filesystems, request validation, ORM integration, database migration and more.</p>

            <h2 class="font-semibold mt-6 text-red-500 hover:text-red-600">
              📚 Full-Stack Support
            </h2>
            <p>Integrated tools for both backend and multi-flavored frontend (gohtml, templ, inertia with react and vue).</p>
            <h2 class="font-semibold mt-6 text-red-500 hover:text-red-600">
              🚀 Scalable
            </h2>
            ...
            <p>Let's you focus on the business logic rather than configuration.</p>
