...
require (
	...
	github.com/lemmego/auth v0.0.0-00010101000000-000000000000
...
replace github.com/lemmego/auth => ../auth
...
require (
	...
	github.com/lemmego/cli v0.0.0-20241116202002-b4fb82b74997 // indirect
